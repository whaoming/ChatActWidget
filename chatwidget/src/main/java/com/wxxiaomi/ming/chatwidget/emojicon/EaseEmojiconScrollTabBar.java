package com.wxxiaomi.ming.chatwidget.emojicon;
...
public class EaseEmojiconScrollTabBar extends RelativeLayout{
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        LayoutInflater.from(context).inflate(R.layout.ming_widget_emojicon_tab_bar, this);
    ...
    public void addTab(int icon){
        ...
        LinearLayout.LayoutParams imgParams = new LinearLayout.LayoutParams(DensityUtils.dip2px(context, tabWidth), LayoutParams.MATCH_PARENT);
